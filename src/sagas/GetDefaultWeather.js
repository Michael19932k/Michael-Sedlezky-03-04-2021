...
function get5DayForecast(chosenCity) {
    const get5DayForecastURL = `http://dataservice.accuweather.com/forecasts/v1/daily/5day/${chosenCity.Key}?apikey=85u8fNhlAIrpOGA8WhtltpfRbPrvWNY8&metric=true`;
...
function getCurrentConditions(chosenCity) {
    const getCurrentConditionsUrl = `http://dataservice.accuweather.com/currentconditions/v1/${chosenCity.Key}?apikey=85u8fNhlAIrpOGA8WhtltpfRbPrvWNY8&language=en-us&details=false`;
